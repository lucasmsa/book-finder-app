...
const Info = () => {
  return <Container>
    ...
    <h2>The idea behind this application was provided by this <a target="_blank" rel="noopener noreferrer" href='https://github.com/florinpop17/app-ideas/blob/master/Projects/2-Intermediate/Book-Finder-App.md'>repository</a>  🦦</h2>
